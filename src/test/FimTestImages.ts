...
export namespace FimTestImages {
  /**
   * Returns a 128x128 pixel JPEG, Base64-encoded. The image consists of four solid-colored squares:
   * - Top-Left = Red
   * - Top-Right = Green
   * - Bottom-Left = Blue
   * - Bottom-Right = Black
  ...
  export function fourSquaresJpeg(): Uint8Array {
    ...
    return Uint8Array.from(atob(jpegString), c => c.charCodeAt(0));
  }
}
