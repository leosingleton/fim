...
describe('Transform3D', () => {
  ...
  it('Initializes to an identity matrix', () => {
    const mat1 = new Transform3D();
    mat1.matrixMultiply(mat1);

    const mat2 = new Transform3D();
  ...
  it('Multiplies by the identity matrix', () => {
    ...
    const mat2 = new Transform3D(mat1);
  ...
  it('Transforms vertex arrays', () => {
    const mat = new Transform3D(); // Identity matrix
    const vertices = TwoTriangles.vertexPositions;
